...
@section('content')
    ...
    <div class="col-lg-12 mt-3">
        <div class="card-style p-4 bg-white rounded">
            ...
            <h4 class="mb-4">
                Add Teacher Salary
                <a href="{{ route('teacher_salary_list') }}" class="btn btn-sm btn-secondary float-end">
            ...
            <form action="{{ route('teacher_salary_save') }}" method="POST" id="salaryForm">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mb-3">
                        ...
                        <select name="teacher_id" id="teacher_id"
                            class="form-control form-select border-primary shadow-sm @error('teacher_id') is-invalid @enderror"
                            required>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            teacherSelect.addEventListener('change', loadAbsent);
            ...
            function loadAbsent() {
                ...
                if (teacherId) {
                    fetch(`/dashboard/get-absent-days/${teacherId}/${year}/${month}`)
                        .then(res => res.json())
                        .then(data => {
            ...
            function calculateNet() {
                const gross = parseFloat(teacherSelect.options[teacherSelect.selectedIndex]?.dataset.gross || 0);
