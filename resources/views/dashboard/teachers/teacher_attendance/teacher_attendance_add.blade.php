...
@section('content')
    <div class="card-body mt-3 ml-3 mr-3 p-4 bg-white rounded">
        <h4 class="card-title mb-4 fw-bold"> Take Attendance</h4>
        ...
        <form class="form-sample" action="{{ route('teacher_attendance_save') }}" method="POST">
            ...
            <div class="table-responsive" style="margin-top:-50px;">
                <table class="table table-bordered align-middle text-center tableD" id="myTable">
                    <thead class="">
                        <tr>
                            <th>ID</th>
                            <th>full Name</th>
                    ...
                    <tbody>
                        @foreach ($Teachers as $index => $Teacher)
                            <tr>
                                ...
                                <td>
                                    <div class="d-inline-flex align-items-center gap-3">
                                        ...
                                        <label class="mb-0 d-flex align-items-center gap-1">
                                            <input type="radio" name="attendance[{{ $Teacher->id }}]" value="present"
                                                checked>
                                            Present
                                        </label>
                                ...
                                <td>
                                    <input type="text" name="remark[{{ $Teacher->id }}]" class="form-control"
