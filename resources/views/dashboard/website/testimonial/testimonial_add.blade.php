...
<div class="card mt-3 ml-3 mr-3">
     <div class="card-body">
        <h4 class="card-title"> add student testimonials </h4><br>
            <form class="form-sample" action="{{ route('testimonial_save') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                     <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control"  placeholder="enter student position" required name="position">
                             @error('position')
                                 <div class="text-danger mt-1">{{ $message }}</div>
                             @enderror
                           </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="number" class="form-control"  placeholder="Please rate the educational center from 1 to 10" required name="reting" min="1" max="10">
                             @error('reting')
                                 <div class="text-danger mt-1">{{ $message }}</div>
                             @enderror
                           </div>
