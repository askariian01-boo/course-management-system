        ...
        <div class="card-style">
            ...
            <form method="GET" class="row g-2 mb-3">
                ...
                <div class="col-12 col-md-4 d-flex gap-2">
                    ...
                    @if (Auth::user()->can('employee_salary_add'))
                        <a href="{{ route('staff_salary_add') }}" class="btn btn-sm btn-primary fw-bold float-right pt-2"
            ...
            <table class="table table-bordered text-center align-middle table-striped table-hover tableD" id="myTable">
                <thead class="table-light">
                    <tr>
                        ...
                        <th style="padding:16px; font-weight:500; font-size:16px;">net_salary</th>
                        ...
                        @if (Auth::user()->can('employee_salary_delete'))
                ...
                <tbody>
                    @forelse($salaries as $salary)
                        <tr>
                            ...
                            <td style="padding:10px;  font-weight:500; font-size:12px;">
                                {{ optional($salary->staff)->GrossSalary ?? 0 }} AFG
                            </td>
                            ...
                            <td style="padding:10px;  font-weight:500; font-size:12px;">
                                <span class="badge {{ $salary->status == 'paid' ? 'bg-success' : 'bg-danger' }}">
                            ...
                            @if (Auth::user()->can('employee_salary_delete'))
                                <td style="padding:10px;  font-weight:500; font-size:12px;">
                                    <form
                                        action="{{ route('staff_salary_delete', [$salary->staff_id, $salary->salary_year, $salary->salary_month]) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
