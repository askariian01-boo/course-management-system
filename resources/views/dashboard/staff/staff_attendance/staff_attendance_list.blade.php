...
@section('content')
    <div class="col-lg-12 mt-3">
        <div class="card-style mb-30">
            <h4 class="mb-4">employee attendance
            </h4>
            <form method="GET" action="" class="row g-2 mb-3">
                ...
                <div class="col-12 col-md-4 d-flex align-items-center gap-2">
                    ...
                    @if (Auth::user()->can('employee_attendance_add'))
                        <a href="{{ route('staff_attendance_add') }}" class="btn btn-primary flex-fill text-white"
                            style="padding-top: 0.65rem; padding-bottom: 0.6rem;">
            ...
            <table class="table table-bordered text-center table-hover table-striped align-middle tableD" id="myTable">
                <thead class="table-light thead-light text-center">
                    <tr>
                        ...
                        @if (Auth::user()->can('employee_attendance_detail'))
                ...
                <tbody>
                    @foreach ($staff_attendance as $staff)
                        <tr>
                            <td>
                                <p><img src="/images/staff/{{ $staff->Image }}" width="50"></p>
                            </td>
                            ...
                            <td>
                                <p>{{ $staff->FatherName }}</p>
                            </td>

                            <td>
                                <p>{{ $staff->absent_days }} - Day</p>
                            </td>
                            @if (Auth::user()->can('employee_attendance_detail'))
                                <td>
                                    <p><a href="{{ route('staff_attendance_detail', $staff->id) }}"
