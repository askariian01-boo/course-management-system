    ...
    <nav class="sidebar-nav">
        ...
        <ul style="margin-left:-15px;">
            <li class="nav-item">
                <a href="{{ route('dashboard') }}">
                    <span class="icon">
                        <i class="fa-solid fa-dashboard text-info"></i>
                    </span>
            ...
            @if (Auth::user()->can('student_menu'))
                <li class="nav-item nav-item-has-children">
                    <a href="#0" class="collapsed" data-bs-toggle="collapse" data-bs-target="#ddmenu_3"
                        ...
                        <i class="fa fa-solid fa-graduation-cap  text-info"></i>
            ...
            @if (Auth::user()->can('exam & score_menu'))
                <li class="nav-item nav-item-has-children">
                    <a href="#0" class="collapsed" data-bs-toggle="collapse" data-bs-target="#ddmenu_5"
                        ...
                        <i class="fa fa-solid fa-bar-chart  text-info"></i>
                        <span class="text" style="margin-left:17px; color:black ; font-weight:600;">exam &
                            score</span>
                    </a>
            ...
            <hr>
            <li class="nav-item nav-item-has-children">
                <a href="#0" class="collapsed" data-bs-toggle="collapse" data-bs-target="#ddmenu_18"
                    aria-controls="ddmenu_18" aria-expanded="false" aria-label="Toggle navigation">
                    <i class="fa fa-desktop text-info"></i>
                    <span class="text" style="margin-left:18px; color:black ; font-weight:600;">website setting</span>
                </a>
                <ul id="ddmenu_18" class="collapse dropdown-nav">
                    <li><a href="{{ route('abouts') }}">abouts</a></li>
            ...
            @if (Auth::user()->can('roles & permission_menu'))
                <li class="nav-item nav-item-has-children">
                    <a href="#0" class="collapsed" data-bs-toggle="collapse" data-bs-target="#ddmenu_7"
                        ...
                        <i class="fa fa-solid fa-user-circle text-info"></i>
